...
class MagneticPreintegrationError : public ::ceres::CostFunction, public ErrorInterface {
 public:
  ...
  typedef std::deque<Eigen::Matrix<double, 6, 6>, Eigen::aligned_allocator<Eigen::Matrix<double, 6, 6>>> Jacobians;
  ...
  virtual std::string typeInfo() const { return "MagnetometerPreintegrationError"; }
